...
**Workspace knows what a Praxis project is** — where `.praxis/` lives, what `config.json` means, what documents are in the tree, and whether the project is healthy. If a thing is Praxis-specific but not about authoring or reviewing, it belongs here rather than in the framework.
