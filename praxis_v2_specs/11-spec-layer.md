...
2. Where does spec *quality* tooling belong (e.g., the axiom authoring gate from 03 advising whether direction is judgeable)? It reads like spec-layer tooling but its verdicts guard the eval layer's integrity. Likely: eval layer owns the gate, spec layer calls it.
