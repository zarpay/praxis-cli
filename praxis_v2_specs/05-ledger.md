...
validator_model, prompt_tokens, completion_tokens, cost_usd
...
id, run_id, timestamp
file_path, spec_path
document_content_hash, spec_content_hash     # provenance: exact inputs
validator_model                              # provenance: exact judge
severity, text
