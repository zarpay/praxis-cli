...
- If no passage supports it but the standard seems real: **not traceable**. The honest response to a real-but-untraceable standard is to extend the specification first — say what is missing.
