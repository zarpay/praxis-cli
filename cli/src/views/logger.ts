 ...
 * where {@link Display} carries the command's actual output, Logger
 * carries what the command has to say about itself. Respects the
 * `NO_COLOR` environment variable and non-TTY streams by automatically
 * disabling color.
 *
