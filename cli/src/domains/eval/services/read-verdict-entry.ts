import type { CacheFileData, ReadVerdictEntryInput, VerdictEntry } from "@/domains/eval/types.js";

import { CACHE_VERSION, CacheFile } from "@/domains/eval/models/cache-file.js";
import readCacheFile from "@/domains/eval/services/read-cache-file.js";
